...
public class carsMLI {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("file_56")).sendKeys("D:\\TCU related\\NEO 4\\SPA2\\NEO4 UAT Build Promotion.msg");
		...
		promotionInstruction.sendKeys("Hi Team ---> Please take the code from SVN repos for Chassis, Acquisition & Fulfilment on UAT env for NEO 4");
		Thread.sleep(3000);
